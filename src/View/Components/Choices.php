                    ...
                    >
                        ...
                        <div
                            ...
                            {{
                                $attributes->except(['wire:model', 'wire:model.live'])->class([
                                    "select select-border max-w-none h-fit pe-16 pb-1 pt-1.5 inline-block cursor-pointer relative flex-1",
                        ...
                        >
                            ...
                            @if (!$compact && $attributes->has('placeholder'))
                                <span @class(["absolute inset-0 mt-2.5 me-8 truncate text-base text-base-content/50 pointer-events-none", $icon ? "ms-10" : "ms-4"]) x-show="isSelectionEmpty && !focused">
                            ...
                            <div wire:key="options-list-{{ $uuid }}" class="{{ $height }} w-full absolute z-10 shadow-xl bg-base-100 border border-base-300 rounded-lg cursor-pointer overflow-y-auto" x-anchor.bottom-start="$refs.container">
                               ...
                               @if($allowAll)
                                   <div
                                        ...
                                        class="font-bold   border border-s-4 border-s-base-300 border-b-base-200 hover:bg-base-200"
                                   >
