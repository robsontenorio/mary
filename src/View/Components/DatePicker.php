        ...
        return <<<'HTML'
            <div wire:key="datepicker-{{ rand() }}">
                ...
                <div class="flex-1 relative">
                    ...
                    <!-- INLINE LABEL -->
                    @if($label && $inline)
                        <div class="absolute text-base-content/50 duration-300 transform -translate-y-1 scale-75 top-2 origin-[0] rounded px-2 @if($inline && $icon) start-9 @else start-3 @endif">
                            {{ $label }}
                        </div>
                    @endif
